...
class MugDetection:
    ...
    def class_to_label(self, x):
        ...
        """
        # global variable
        variable= self.classes[int(x)]
        # print(variable)
        
        if variable=="5cm/sec":
            ser.write(bytearray('1','ascii'))
            print("speed increase to ", variable)

        if variable=="10cm/sec":
            ser.write(bytearray('2','ascii'))
            print("speed increase to ", variable)
      
        if variable=="20cm/sec":
    ...
    def __call__(self):
        ...
        # cap=cv2.VideoCapture("Your ip adress")
        assert cap.isOpened()
